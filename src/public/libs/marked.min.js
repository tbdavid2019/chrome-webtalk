    ...
    blockquote(e) {
      ...
      if (t) {
        ...
        for (; e.length > 0; ) {
          ...
          if (
            ((this.lexer.state.top = !0), this.lexer.blockTokens(a, r, !0), (this.lexer.state.top = c), 0 === e.length)
          )
            break
  ...
  class ee {
    ...
    constructor(t) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((n.block = W.gfm), this.options.breaks ? (n.inline = Y.breaks) : (n.inline = Y.gfm)),
